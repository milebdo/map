...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        <header class="logo hidden-xs">
            <a class="navbar-brand" href="{{ url('/admin/maps/list') }}">
            {{ App\Brand::where('active', 1)->first()->name }}
            </a>
        </header>
        ...
        <ul class="sidebar-nav">
            <li>
                <a href="{{ url('/admin/maps/list') }}" class="item" onClick="window.location.reload()">
                    <span class="icon">
            ...
            <li class="dropdown">
                <a class="collapsed"  href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    ...
                    {{ trans('backoffice.system') }}
                    <i class="toggle fa fa-angle-down"></i></a>
                    <ul id="sidebar-dashboard" class="collapse">
                        <li>
                            <a href="{{ url('/admin/users/list') }}" class="item" onClick="window.location.reload()">
                                <span class="icon">
                        ...
                        <li>
                            <a href="{{ url('/admin/roles/list') }}" class="item" onClick="window.location.reload()">
                                <span class="icon">
                                    <i class="fa fa-users"></i>
                                </span>
                                {{ trans('backoffice.roles') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('/admin/permissions/list') }}" class="item" onClick="window.location.reload()">
                                <span class="icon">
                                    <i class="fa fa-ban"></i>
                                </span>
                                {{ trans('backoffice.permissions') }}
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    <li>
                        ...
                        <a onClick="window.location.reload()" class="hidden-sm hidden-xs" id="nav-state-toggle" href="#" title="Turn on/off sidebar collapsing" data-placement="bottom">
